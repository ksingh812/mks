    ...
    class aaTeamPluginDepedencies
    {
	    ...
	    */
		...
		public function depedencies_plugin_redirect_valid() {
			//delete_option('wwcAmzAff_depedencies_is_valid');
		...
		public function depedencies_plugin_redirect() {
			...
			delete_option('wwcAmzAff_depedencies_do_activation_redirect');
			wp_redirect( get_admin_url() . 'admin.php?page=wwcAmzAff' );
		}
		...
		public function verifyDepedencies() {
			...
			?>
			<input type="button" value="Re-Check Depedencies" class="wwcAmzAff-button blue wwcAmzAff-depedencies-check" style="margin-top: 10px;">
			<?php
