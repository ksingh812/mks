...
if (class_exists('wwcAmzAffAdvancedSearch') != true) {
    class wwcAmzAffAdvancedSearch
    {
        /*
        ...
        */
        public function __construct($cfg, $module)
        {
            ...
            $this->cfg    = $cfg;
            $this->module = $module;
			$this->amz_setup = $wwcAmzAff->getAllSettings('array', 'amazon');
        }
...
?>
<style>#wwcAmzAff-advanced-search {display: none;}</style>
...
<div id="wwcAmzAff-advanced-search">
	<!-- Main loading box -->
	<div id="main-loading">
	...
	<table id="wwcAmzAff-layout-table" border="0" width="100%" cellspacing="0" cellpadding="15">
		<tr>
			<td class="col1" width="200" style="vertical-align: top">
				<ul class="wwcAmzAff-categories-list">
			...
			<td class="col2" width="500"  style="vertical-align: top">
				<div class="wwcAmzAff-parameters-list" id="wwcAmzAff-parameters-container"> <p>loading ...</p></div>
			</td>
			<td class="col3" style="vertical-align: top">
				<div class="wwcAmzAff-product-list"><!-- dinamyc content here --></div>
			</td>
		</tr>
	</table>
</div>
...
// Initalize the your wwcAmzAffAdvancedSearch
$wwcAmzAffAdvancedSearch = new wwcAmzAffAdvancedSearch($this->cfg, $module);