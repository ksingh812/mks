<?php
/*
* Define class wwcAmzAffStatsProd
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
      
if (class_exists('wwcAmzAffStatsProd') != true) {
    class wwcAmzAffStatsProd
    {
        /*
	    ...
	    * Singleton pattern
	    *
	    * @return wwcAmzAffStatsProd Singleton instance
	    */
...
// Initialize the wwcAmzAffStatsProd class
$wwcAmzAffStatsProd = wwcAmzAffStatsProd::getInstance();
