<?php
/*
* Define class wwcAmzAffSetupBackup
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('wwcAmzAffSetupBackup') != true) {
    class wwcAmzAffSetupBackup
    {
        /*
	    ...
	    * Singleton pattern
	    *
	    * @return wwcAmzAffSEOImages Singleton instance
	    */
...
// Initialize the wwcAmzAffSetupBackup class
$wwcAmzAffSetupBackup = wwcAmzAffSetupBackup::getInstance();