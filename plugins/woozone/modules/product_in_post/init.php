<?php
/*
* Define class wwcAmzAffProductInPost
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;

if (class_exists('wwcAmzAffProductInPost') != true) {
    class wwcAmzAffProductInPost
    {
        /*
        ...
        */
        public function __construct()
        {
			...
			add_action('wp_ajax_wwcAmzAffProductInPost', array( $this, 'ajax_request' ));
			
			add_shortcode( 'wwcAmzAffProducts', array( $this, 'shortcode' ) );
		...
		{
			wp_enqueue_style( 'wwcAmzAffProducts', plugins_url('style.css', __FILE__) );
		}
		...
		public function add_product_inline()
		{
			...
			$html[] = '<div class="add_product_inline" id="wwcAmzAffAddProductInline">';
			$html[] = 	'<div>';
		...
		public function fb_add_tinymce_plugin( $plugin_array ) 
		{
		    ...
		    $plugin_array['product_in_post'] = plugins_url( '/app.class.js', __FILE__ );
		...
		public function product_in_page()
		{
			...
			$html[] = '<div id="wwcAmzAffAddProduct">';
			//$html[] = 	'<h2>Add Amazon Product(s)<h2>';
			/*$html[] = 		'<ul class="wwcAmzAffChooseMenu">';
			$html[] = 			'<li><a href="#" rel="wwcAmzAffAddAsinsCode" class="on">Based on ASIN code(s)</a></li>';
			$html[] = 			'<li><a href="#" rel="wwcAmzAffAddImportedProducts">Imported Products</a></li>';
			$html[] = 		'</ul>';
			
			$html[] = 		'<div id="wwcAmzAffAddAsinsCode">';
			$html[] = 			'<label>ASIN(s)</label>';
			$html[] = 			'<input type="text" class="wwcAmzAffAddCode" id="wwcAmzAffAddCode" />';
			...
			*/
			...
			$html[] = 		'<div id="wwcAmzAffAddImportedProducts"></div>';
		...
		public function ajax_request()
		{
			...
			$html[] = '<div id="wwcAmzAffListOfProducts">';
			$html[] = 	'<div class="wwcAmzAffAllProducts">';
			...
			$html[] = 		'</ul>';
			$html[] = 	'</div>';
			$html[] = 	'<div class="wwcAmzAffChosenProducts">
				<h4>' . ( __( 'Chosen Product(s)', $this->the_plugin->localizationName ) ) . ':</h4>
				<ul class="wwcAmzAffChosenProducts-list">
			...
			$html[] = '<script>
				wwcAmzAffProductInPost.trigger_select_products(); 
			</script>';
		...
		public function shortcode( $atts )
		{
			...
			foreach ($products as $key => $product) {
				...
				$html[] = '<div class="wb-product">
					<div class="wb-left">
						<div class="wb-prod-image">
							...
							<a href="' . ( $product['fullimage'][0] ) . '" class="thickbox">See larger image</a>
						</div>
					</div>
					<div class="wb-right">
				...
				if( $atts['gallery'] == true && count($product['images']) > 0 ){
				...
				$html[] = '
						...
						<a href="' . ( $prod_link ) . '" class="wb-buy" target="_blank">Buy Now</a>
					</div>
				</div>'; 
			}
	    ...
	    * Singleton pattern
	    *
	    * @return wwcAmzAffProductInPost Singleton instance
	    */
...
// Initialize the wwcAmzAffProductInPost class
$wwcAmzAffProductInPost = wwcAmzAffProductInPost::getInstance();