...
echo json_encode(
	...
	array(
		...
		$tryed_module['db_alias'] => array(
			...
			'module_box' => ($wwcAmzAff->get_plugin_status() != 'valid_hash' ? array(

					'title' 	=> __('Unlock - Premium SEO Pack', 'wwcAmzAff'),
					...
					'elements'	=> array(
						...
						,'productKey' => array(
							...
							'title' 	=> __('Item Purchase Code', 'wwcAmzAff'),

							'desc' 		=> __('Get it from CodeCanyon account and go to your “Downloads�? page.', 'wwcAmzAff')
						...
						,'yourEmail' => array(
							...
							'title' 	=> __('Your Email', 'wwcAmzAff'),

							'desc' 		=> __('We will notify you via this email about this product update and bug fix.', 'wwcAmzAff')
						...
						,'sendActions' => array(
							...
							'options'	=> array(
								...
								array(
									...
									'action' 	=> 'wwcAmzAff_activate_product',
				...
				: array(
					...
					'title' 	=> __('Modules Manager', 'wwcAmzAff'),
