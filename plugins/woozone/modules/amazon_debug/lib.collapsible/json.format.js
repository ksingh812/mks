...
wwcAmzAffAmazonDebug = (function($) {
	...
	var SINGLE_TAB = "  ",
		lib_path = $id('wwcAmzAff-amzdbg-datael').getAttribute('alt'),
	...
	function triggers() {
		// format json
		$('#wwcAmzAff-amzdbg-amazonResponse #GoFormatJson').click(function(e) {
			e.preventDefault();
		...
		$('#wwcAmzAff-amzdbg-amazonResponse #TabSize').click(function(e) {
			e.preventDefault();
		...
		$('#wwcAmzAff-amzdbg-amazonResponse #QuoteKeys').click(function(e) {
			//e.preventDefault();
		...
		$('#wwcAmzAff-amzdbg-amazonResponse #CollapsibleView').click(function(e) {
			//e.preventDefault();
		...
		$('#wwcAmzAff-amzdbg-amazonResponse #SelectAll').click(function(e) {
			e.preventDefault();
		...
		$('#wwcAmzAff-amzdbg-amazonResponse #CollapsibleViewDetail #CollapsibleViewExpandAll').click(function(e) {
			e.preventDefault();
			
			ExpandAllClicked();
		});
		// change json display: collapsible view collapse all
		$('#wwcAmzAff-amzdbg-amazonResponse #CollapsibleViewDetail #CollapsibleViewCollapseAll').click(function(e) {
			e.preventDefault();
			
			CollapseAllClicked();
		});
		// change json display: collapsible view level specific!
		$('#wwcAmzAff-amzdbg-amazonResponse #CollapsibleViewDetail .CollapsibleViewLevel').click(function(e) {
			e.preventDefault();
		...
		// json tree toogle
		$('#wwcAmzAff-amzdbg-amazonResponse').on('click', 'img.ExpImgChoose', function(e) {
			e.preventDefault();
