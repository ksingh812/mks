	...
	class amazonDebug {
		...
		*/
		...
		public function printListInterface ()
		{
			...
			$html[] = '<script type="text/javascript" src="' . ( $this->module['folder_uri'] ) . 'app.class.js" ></script>';
			$html[] = "<link rel='stylesheet' id='wwcAmzAff-bulk-css' href='" . ( $this->module['folder_uri'] ) . "extra-style.css' type='text/css' media='all' />";

			
			ob_start();
		?>
			<div id="wwcAmzAff-amazonDebug">
				<div>
					<div class="wwcAmzAff-amzdbg-ResponseGroups-Head">
						<span style="display: none;" id="wwcAmzAff-amzdbg-datael" alt="<?php echo $this->module['folder_uri'] . 'lib.collapsible/'; ?>"></span>
						<input type="hidden" id="wwcAmzAff-amzdbg-default" name="wwcAmzAff-amzdbg-default" value="<?php echo implode(',', self::$ResponseGroups_default); ?>" />
						<input id="wwcAmzAff-amzdbg-rg[all]" type="checkbox" name="wwcAmzAff-amzdbg-rg[all]" value="all" <?php echo count(self::$ResponseGroups) == count(self::$ResponseGroups_default) ? 'checked="checked" ' : ''; ?>/>
						<label for="wwcAmzAff-amzdbg-rg[all]">Check / Uncheck All</label>
						
						<a href="#" class="wwcAmzAff-button gray" id="wwcAmzAff-amzdbg-rg-godefault">Restore to default reponse groups</a>

						<a href="<?php echo self::$ResponseGroups_parenturl; ?>" class="wwcAmzAff-button orange wwcAmzAff-amz-docs-details" target="_blank">Amazon Available Response Groups</a>
						
					</div>
					<?php /*<div style="clear: both;"></div>*/ ?>
					<ul class="wwcAmzAff-amzdbg-ResponseGroups">
						<?php
						...
						?>
							<li>
								<input id="wwcAmzAff-amzdbg-rg[<?php echo $key; ?>]" type="checkbox" name="wwcAmzAff-amzdbg-rg[]" value="<?php echo $key; ?>" <?php echo $checked ? 'checked="checked" ' : ''; ?>/>
								<label for="wwcAmzAff-amzdbg-rg[<?php echo $key; ?>]">
					...
					<div class="wwcAmzAff-amzdbg-exec">
						<label for="wwcAmzAff-amzdbg-asin">ASIN code:</label>
						<input id="wwcAmzAff-amzdbg-asin" type="text" class="" name="wwcAmzAff-amzdbg-asin" value="B00KT9AFKW" />
						
						<a href="#" class="wwcAmzAff-button blue" id="wwcAmzAff-amzdbg-getAmzResponse">Get Amazon Response</a>
					</div>
					
					<div id="wwcAmzAff-amzdbg-amazonResponse">
						<?php
