<?php
/*
* Define class wwcAmzAffAssetDownload
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;

if ( !class_exists('wwcAmzAffAssetDownload') ) {
    class wwcAmzAffAssetDownload
    {
        /*
        ...
        */
        public function __construct()
        {
			...
			add_action('wp_ajax_wwcAmzAff_download_asset', array( &$this, 'ajax_download_asset' ));
			add_action('wp_ajax_wwcAmzAffDeleteAssetsProducts', array( &$this, 'delete_products_asset' ));
			//$this->__test_assets();
        }
	    ...
	    * Singleton pattern
	    *
	    * @return wwcAmzAffAssetDownload Singleton instance
	    */
...
?>
		...
		<div id="wwcAmzAff-wrapper" class="fluid wrapper-wwcAmzAff wwcAmzAff-asset-download">
			
			<?php
			// show the top menu
			wwcAmzAffAdminMenu::getInstance()->make_active('info|assets_download')->show_menu();
			?>
			...
			<div id="wwcAmzAff-content">
				...
				<h1 class="wwcAmzAff-section-headline">
					...
					if( isset($this->module['assets_download']['in_dashboard']['icon']) ){
						echo '<img src="' . ( $this->module_folder . $this->module['assets_download']['in_dashboard']['icon'] ) . '" class="wwcAmzAff-headline-icon">';
					}
					?>
					<?php echo $this->module['assets_download']['menu']['title'];?>
					<span class="wwcAmzAff-section-info"><?php echo $this->module['assets_download']['description'];?></span>
					<?php
					...
					if( $has_help === true ){
						...
						if( $help_type == 'remote' ){
							echo '<a href="#load_docs" class="wwcAmzAff-show-docs" data-helptype="' . ( $help_type ) . '" data-url="' . ( $this->module['assets_download']['help']['url'] ) . '">HELP</a>';
						} 
					}
						...
						<div id="wwcAmzAff-content-area">
                            ...
                            <div class="wwcAmzAff-grid_4">
	                        	<div class="wwcAmzAff-panel">
									...
									<div class="wwcAmzAff-panel-content">
										<div class="wwcAmzAff-sync-details">
...
/*if ( !function_exists('wwcAmzAffAssetDownload_cronjob') ) {
function wwcAmzAffAssetDownload_cronjob() {
	// Initialize the wwcAmzAffAssetDownload class
	$amzaffAssetDownload = new wwcAmzAffAssetDownload();
	$amzaffAssetDownload->cronjob();
}
}*/

// Initialize the wwcAmzAffAssetDownload class
$wwcAmzAffAssetDownload = wwcAmzAffAssetDownload::getInstance();