<?php
/*
* Define class wwcAmzAffCronjobsConfig
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('wwcAmzAffCronjobsConfig') != true) {
    class wwcAmzAffCronjobsConfig
    {
        /*
        ...
        * Singleton pattern
        *
        * @return wwcAmzAffCronjobsConfig Singleton instance
        */
...
//$wwcAmzAffCronjobsConfig = new wwcAmzAffCronjobsConfig();
//$wwcAmzAffCronjobsConfig = wwcAmzAffCronjobsConfig::getInstance();