<?php
/*
* Define class wwcAmzAffCronjobs
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('wwcAmzAffCronjobs') != true) {
    class wwcAmzAffCronjobs
    {
        /*
        ...
        */
		...
		public function build_config() {
            ...
            $cronObj = new wwcAmzAffCronjobsConfig($this->the_plugin);
            ...
            $external_func_status = array();
            {
                switch ($cron_id) {
                    ...
                    case 'report':
                        ...
                        $wwcAmzAffReport = new wwcAmzAffReport();
                        
                        $external_func_status = $wwcAmzAffReport->cronjob( $cron, 'return' );
                        break;
                }
            }
...
//$wwcAmzAffCronjobs = new wwcAmzAffCronjobs();
//$wwcAmzAffCronjobs = wwcAmzAffCronjobs::getInstance();